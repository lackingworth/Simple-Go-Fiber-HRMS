...
const mongoURI = "mongodb://localhost:27017" + dbName // local db, otherwise paste provided URI; Depending on config you may write "user@password" before the localhost
...
func main() {
	...
	app.Put("/employee/:id", func(c *fiber.Ctx) error {
		...
		idPar := c.Params("id")
		employeeId, err := primitive.ObjectIDFromHex(idPar)
